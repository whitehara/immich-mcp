...
async def test_list_all_albums(registered):
    ...
    result = await get_fn(mcp, "immich_albums_list")()
...
async def test_list_shared_filter(registered):
    ...
    await get_fn(mcp, "immich_albums_list")(shared=True)
...
async def test_get_album(registered):
    ...
    result = await get_fn(mcp, "immich_albums_get")("a1")
...
async def test_create_album_minimal(registered):
    ...
    result = await get_fn(mcp, "immich_albums_create")("Trip")
...
async def test_create_album_with_assets(registered):
    ...
    await get_fn(mcp, "immich_albums_create")(
...
async def test_update_album(registered):
    ...
    await get_fn(mcp, "immich_albums_update")("a1", album_name="New Name")
...
async def test_delete_album(registered):
    ...
    result = await get_fn(mcp, "immich_albums_delete")("a1")
...
def test_delete_is_destructive(registered):
    mcp, _ = registered
    ann = get_annotations(mcp, "immich_albums_delete")
...
async def test_add_assets(registered):
    ...
    await get_fn(mcp, "immich_albums_add_assets")("a1", ["id1", "id2"])
...
async def test_remove_assets(registered):
    ...
    await get_fn(mcp, "immich_albums_remove_assets")("a1", ["id1"])
...
async def test_get_adds_web_url_to_album_and_assets(registered):
    ...
    result = await get_fn(mcp, "immich_albums_get")("alb-1")
