...
def register(mcp: FastMCP) -> None:
    @mcp.tool(
        ...
        annotations=ToolAnnotations(title="List Shared Links", readOnlyHint=True, idempotentHint=True),
    )
    ...
    @mcp.tool(
        ...
        annotations=ToolAnnotations(title="Get Shared Link", readOnlyHint=True, idempotentHint=True),
    )
    ...
    @mcp.tool(
        ...
        annotations=ToolAnnotations(title="Create Shared Link"),
    )
    ...
    @mcp.tool(
        ...
        annotations=ToolAnnotations(title="Update Shared Link", idempotentHint=True),
    )
    ...
    @mcp.tool(
        ...
        annotations=ToolAnnotations(title="Remove Shared Link", destructiveHint=True, idempotentHint=True),
    )
