...
def register(mcp: FastMCP) -> None:
    @mcp.tool(
        ...
        annotations=ToolAnnotations(title="List Assets", readOnlyHint=True, idempotentHint=True),
    )
    ...
    @mcp.tool(
        ...
        annotations=ToolAnnotations(title="Get Asset", readOnlyHint=True, idempotentHint=True),
    )
    ...
    @mcp.tool(
        ...
        annotations=ToolAnnotations(title="View Asset URLs", readOnlyHint=True, idempotentHint=True),
    )
    ...
    @mcp.tool(
        ...
        annotations=ToolAnnotations(title="Upload Asset"),
    )
    ...
    @mcp.tool(
        ...
        annotations=ToolAnnotations(title="Update Asset", idempotentHint=True),
    )
    ...
    @mcp.tool(
        ...
        annotations=ToolAnnotations(title="Bulk Update Assets", idempotentHint=True),
    )
    ...
    @mcp.tool(
        ...
        annotations=ToolAnnotations(title="Delete Assets", destructiveHint=True, idempotentHint=True),
    )
    ...
    @mcp.tool(
        ...
        annotations=ToolAnnotations(title="Asset Statistics", readOnlyHint=True, idempotentHint=True),
    )
